...
const handleErrorResponse = (error: any, thunkAPI: any): any => {
  if (error.response) {
...
const showsSlice = createSlice({
  ...
  extraReducers(builder) {
    builder
      ...
      .addCase(fetchAllShows.rejected, (state: any, action) => {
        state.isLoading.fetchAllShows = false;
      ...
      .addCase(fetchSingleShow.rejected, (state: any, action) => {
        state.isLoading.fetchSingleShow = false;
